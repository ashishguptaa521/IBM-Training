...
public class StreamDemo4 {
	...
	public static void main(String[] args) {
		...
		// Collect all the cities in upper case into a list of cities and print
		...
		// lucky number
		List<String> lst = contacts.values().stream().flatMap(Collection::stream).filter(c -> c.contains("7"))
